#! /usr/bin/env python3
"""Implement Tarjan's algorithm for finding SCCs, then find any edges that
connect separate SCCs, marking them as critical edges.
"""
...
if __name__ == "__main__":
    ...
    critical_connections = criticalConnections(node_count, connections)
